...
import parbft.consensus.Decision;
import parbft.consensus.messages.ConsensusMessage;
import parbft.consensus.messages.MessageFactory;
...
public final class ExecutionManager {
    ...
    public ExecutionManager(ServerViewController controller, Primary primary,
        ...
        // Get initial leader
        //TODO lots_of_problems_here
        if (controller.getCurrentViewBackups(controller.getStaticConf().getGroup(controller.getStaticConf().getProcessId())).length > 0)
            currentLeader = controller.getCurrentViewBackups(controller.getStaticConf().getGroup(controller.getStaticConf().getProcessId()))[0];
    ...
    public int getCurrentLeader(int group) {
        return currentLeader;
    }
