...
import parbft.reconfiguration.VMMessage;
...
public class ServerConnection {
    ...
    private boolean isToConnect() {
        ...
        if (this.controller.isInCurrentView()) {
            if (this.controller.getStaticConf().getProcessId() > remoteId&&(controller.getStaticConf().getGroup(this.controller.getStaticConf().getProcessId()))==controller.getStaticConf().getGroup(remoteId)) {
                ret = true;
            }
                    ...
                    try {
                        ...
                        if (result) {
                            ...
                            if (sm.getSender() == remoteId) {
                                ...
                                /*if (!inQueue.offer(sm)) {
                                parbft.tom.util.Logger.println("(ReceiverThread.run) in queue full (message from " + remoteId + " discarded).");
