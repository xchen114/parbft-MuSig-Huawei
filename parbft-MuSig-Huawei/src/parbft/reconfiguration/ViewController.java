...
import parbft.reconfiguration.util.TOMConfiguration;
import parbft.reconfiguration.views.DefaultViewStorage;
import parbft.reconfiguration.views.View;
import parbft.reconfiguration.views.ViewStorage;
...
public class ViewController {
    ...
    public int getCurrentViewN(int group) {
        return getCurrentView().getN(group);
    }
    ...
    public int[] getCurrentViewProcesses(int group) {
        return getCurrentView().getGroupProcesses(group);
    }
}