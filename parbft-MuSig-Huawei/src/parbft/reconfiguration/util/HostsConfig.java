 ...
 */
package parbft.reconfiguration.util;
...
//                        #########################################
                        int group = Integer.valueOf(str.nextToken());
//                        #########################################
                        this.servers.put(id, new Config(id,host,port,group));
                    }
                }
            }
            fr.close();
    ...
    public void add(int id, String host, int port,int group ){
    ...
    public class Config{
        ...
        public Config(int id, String host, int port,int group){
            this.id = id;
            this.host = host;
            this.port = port;
            this.group = group;
