...
public class Configuration {
    ...
    public final int getGroup(int id){
        return hosts.getGroup(id);
    }

    public final void addHostInfo(int id, String host, int port,int group){
        this.hosts.add(id,host,port,group);
    }
